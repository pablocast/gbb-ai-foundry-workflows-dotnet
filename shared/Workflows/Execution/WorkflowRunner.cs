...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    /// </summary>
    private ValueTask<ExternalInputResponse> HandleExternalRequestAsync(ExternalRequest request)
    {
        ...
        {
            foreach (ChatMessage responseMessage in this.ProcessInputMessageAsync(message))
            {
        ...
        return ValueTask.FromResult(new ExternalInputResponse(responseMessages));  
    }

    private IEnumerable<ChatMessage> ProcessInputMessageAsync(ChatMessage message)
    {
